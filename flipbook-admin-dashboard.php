...
<body>
        ...
        <div class="dashboard-content">
            ...
            <div id="createSection" class="section" style="display: none;">
                ...
                <div id="step2" class="step-content">
                    ...
                    <button onclick="goToStep(3)" id="audioUploadBtn" class="btn btn-primary" style="display: none;">Next: Reorder Pages</button>
                </div>

                <!-- Step 3: Reorder Pages -->
                <div id="step3" class="step-content">
                    <h3>Step 3: Reorder Pages (Optional)</h3>
                    ...
                    <button onclick="goToStep(4)" class="btn btn-primary" style="margin-top: 20px;">Continue to Upload Audio</button>
                </div>

                <!-- Step 4: Audio Upload -->
                <div id="step4" class="step-content">
                    <h3>Step 4: Upload MP3 Files</h3>
                    ...
                    <button onclick="goToStep(5)" class="btn btn-primary">Next: Assign Audio to Pages</button>
                </div>

                <!-- Step 5: Assign Audio to Pages -->
                <div id="step5" class="step-content">
                    <h3>Step 5: Assign Audio to Pages</h3>
    ...
    <script src="flipbook-admin-v6.js"></script>
</body>
</html>
